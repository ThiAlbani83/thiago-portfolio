...
const Contact = () => {
  return (
    <section className="flex flex-col gap-10 px-5 -mt-10 md:-mt-52 lg:-mt-52 xl:-mt-[210px] 2xl:-mt-[275px] md:gap-16 sm:px-7 md:px-20 lg:px-24 xl:px-36 2xl:px-60">
      <div className="flex items-center gap-0">
        <span className="text-[32px] text-[#59F268]">/</span>
        <h2 className="text-[32px] font-semibold text-white w-full max-w-[150px]">
          contacts
        </h2>
      </div>
